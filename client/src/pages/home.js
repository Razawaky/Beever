...
document.querySelector('#app').innerHTML = `
    ...
    <ul class="space-y-2 font-medium">
        <li>
            <a href="./pages/login.js" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
    ...
    <div class=" flex justify-center border-2 border-gray-600 p-4">
        <div class="bg-blue-500 text-white p-2">Elemento à Esquerda</div>
    </div>
